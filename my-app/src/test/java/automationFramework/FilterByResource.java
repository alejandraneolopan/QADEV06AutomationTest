...
public class FilterByResource {
  ...
  public void testAssociateResourceToRoom() throws Exception {
    ...
    Assert.assertTrue(isElementPresent(By.xpath("//*[@id='roomsGrid']/div[2]/div/div[" + rowRoomNum + "]/div[" + resourceColumn + "]/div[2]/div/div/div/span[2]")));
   /*Clean*/ 
    roomElement.click();
    doubleclick(driver, roomElement);
  driver.findElement(By.linkText("Resource Associations")).click();
